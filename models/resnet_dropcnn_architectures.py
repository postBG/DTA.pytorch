...
def create_cnn_drop_resnet_lower(model_name='resnet50', pretrained=True):
    """
...
def create_cnn_drop_resnet_upper(model_name='resnet50', pretrained=True, num_classes=12):
    """
    ResNet options: ResNet50, ResNet101, ResNet152
    :param model_name: resnet50, resnet101, resnet152
    :param pretrained: call pretrained model
